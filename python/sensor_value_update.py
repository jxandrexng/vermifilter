...
class Application(Frame):
	...
	def createWidgets(self):
		...
		self.temperature = Label(self, textvariable=self.temperature_data, font=('Verdana', 20, 'bold'))
		self.temperature_data.set("Temperature")
		self.temperature.pack()

		self.soil_moisture = Label(self, textvariable=self.soil_moisture_data, font=('Verdana', 20, 'bold'))
